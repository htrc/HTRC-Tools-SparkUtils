[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/htrc/HTRC-Tools-SparkUtils/ci.yml?branch=main)](https://github.com/htrc/HTRC-Tools-SparkUtils/actions/workflows/ci.yml)
